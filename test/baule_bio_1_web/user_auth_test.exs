defmodule BauleBio1Web.UserAuthTest do
  use BauleBio1Web.ConnCase, async: true

  alias Phoenix.LiveView
  alias BauleBio1.Accounts
  alias BauleBio1.Accounts.Scope
  alias BauleBio1Web.UserAuth

  import BauleBio1.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BauleBio1Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BauleBio1Web.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        BauleBio1Web.Endpoint.subscribe("users_sessions:#{Base.url_encode64(token)}")
      end
